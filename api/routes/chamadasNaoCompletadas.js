module.exports = async function(app){
  app.get('/chamadasNaoCompletadas', function(req,res1){  
    ...
    const options = {
      ...
      "port": null,
      "path": "/api/v1/campaign_missed_calls?filter[started_at]="+dth_inicial+"T00:00:00.000Z,"+dth_final+"T23:59:59.999Z&filter[campaign]="+ idCampanha,
      "headers": {
